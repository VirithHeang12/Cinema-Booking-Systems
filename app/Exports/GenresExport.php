...
class GenresExport implements FromView, WithStyles, ShouldAutoSize, WithTitle
{
    private $data;
    ...
    public function styles(Worksheet $sheet): void
    {
        ...
        /// last row
        $lastRow            = count($this->data['genres']) + 4;
