                            ...
                            <div class="row g-0">
                                <div class="col-12 col-md-6 p-5 rounded-tl-[25px] rounded-bl-[25px] min-h-[480px] md:!h-[480px] !text-white"
                                    ...
                                    <p class="d-flex">
                                        ...
                                        <span class="ms-2 text-[#bcbcbc]">Duration:</span> &nbsp;<strong>{{ movie.duration }}</strong>
                                    </p>
                                    <p class="d-flex">
                                        <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <span class="ms-2 text-[#bcbcbc]">Release:</span>&nbsp;<strong>{{ formatDate(movie.release_date) }}</strong>
                                    </p>
                                    <p class="d-flex">
                                        ...
                                        <span class="ms-2 text-[#bcbcbc]">Classification:</span>&nbsp;<strong>{{ movie.classification }}</strong>
                                    </p>
                                </div>
                                <div class="col-12 col-md-6 h-100">
                                    <div class="relative h-100">
                                        ...
                                        <div class="w-100 h-100">
                                            <v-btn  v-if="!dialog"  @click="dialog = true" elevation="4" class="bg-red absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" icon="mdi-play"></v-btn>
                                        </div>
                                    </div>
                                </div>
                            </div>
