                    ...
                    <div class="row g-0">
                        <div class="col-12 col-md-6 p-5 rounded-tl-[25px] rounded-bl-[25px] min-h-[480px] md:!h-[480px] !text-white"
                            ...
                            <p class="d-flex">
                                ...
                                <span class="ms-2 text-[#bcbcbc]">Genre:</span> &nbsp;<strong>Concert</strong>
                            </p>
                            <p class="d-flex">
                                <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span class="ms-2 text-[#bcbcbc]">Duration:</span> &nbsp;<strong>2h 8min</strong>
                            </p>
                            <p class="d-flex">
                                <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <g id="SVGRepo_iconCarrier">
                                        <path
                                            ...
                                            stroke="#CB0F15" stroke-width="2" stroke-linecap="round"
                                            stroke-linejoin="round"></path>
                                        <path d="M8 14L16 14" stroke="#CB0F15" stroke-width="2" stroke-linecap="round"
                                            stroke-linejoin="round"></path>
                                    </g>
                                </svg>

                                <span class="ms-2 text-[#bcbcbc]">Release:</span>&nbsp;<strong>02 Apr 2025</strong>
                            </p>
                            <p class="d-flex">
                                ...
                                <span class="ms-2 text-[#bcbcbc]">Classification:</span>&nbsp;<strong>G</strong>
                            </p>
                        </div>
                        <div class="col-12 col-md-6">
                            <img src="/public/image/seventeen.jpg" alt="SEVENTEEN Concert"
                                class="img-fluid rounded-tr-[25px] rounded-br-[25px] w-100 min-h-[480px] md:!h-[480px] img-cus object-cover" />
                        </div>
                    </div>
                </div>
            </div>
