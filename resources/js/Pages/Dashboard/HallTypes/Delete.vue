        ...
        <form @submit.prevent="submitForm()">
            <div class="delete-modal-container">
                ...
                <div class="delete-content">
                    <h3 class="delete-title">Delete Halltype</h3>
                    <p class="delete-message">Are you sure you want to delete <span class="hall-type-name">{{ hall_type.name
                        || 'this halltype' }}</span>?</p>
