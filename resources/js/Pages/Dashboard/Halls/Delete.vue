            ...
            <div class="delete-modal-container">
                <div class="flex gap-3 w-full">
                    ...
                    <div class="grid text-left">
                        <h3 class="font-semibold !text-zinc-800">{{__('Delete Hall')}}</h3>
                        <p class="text-dm text-neutral-600 font-medium mb-1">
                           {{__('Are you sure you want to delete')}}
                            <span class="!text-zinc-700 font-semibold">{{ hall.name || "this hall" }}</span>?
                        </p>
...
<script setup>
    ...
    /**
     * Submit the form to delete the hall.
     *
     * @returns {void}
     */
    const submitForm = () => {
        router.delete(route("dashboard.halls.destroy", {
            hall: props.hall.id,
        }));
    };
</script>
