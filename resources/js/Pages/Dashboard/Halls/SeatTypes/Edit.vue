    ...
    <Modal v-slot="{ close }">
        <div class="form-container">
            <div class="form-header !mb-3">
                <h2 class="form-title">{{ __('Edit Hall Seat Type') }}</h2>
...
<script setup>
     ...
     */
    onMounted(() => {
        form.seat_type_id = props.seat_type.seat_type_id;
        form.maximum_capacity = props.seat_type.maximum_capacity;
        form.rows = props.seat_type.rows;
    });
    ...
    const submitForm = (setErrors, close) => {
        form.transform((data) => ({
            ...
            route("dashboard.halls.seat_types.update", {
                hall: props.hall.id,
