            ...
            <div class="delete-modal-container">
                <div class="flex gap-3 w-full">
                    ...
                    <div class="grid text-left">
                        <h3 class="font-semibold !text-zinc-800">Delete Seat Type</h3>
                        <p class="text-dm text-neutral-600 font-medium mb-1">
                            Are you sure you want to delete this seat type? </p>
...
<script setup>
    ...
    /**
     * Submit the form to delete the show.
     *
     * @returns {void}
     */
    const submitForm = () => {
        router.delete(route("dashboard.halls.seat_types.destroy", {
            hall: props.hall.id,
