        ...
        <form @submit.prevent="submitForm()">
            <div class="delete-modal-container">
                ...
                <div class="delete-content">
                    <h3 class="delete-title">Delete Screen Type</h3>
                    <p class="delete-message">
                        Are you sure you want to delete
                        <span class="movie-title">{{
                            screen_type.name || "this screen type"
                        }}</span
                        >?
                    </p>
...
<script setup>
    ...
    /**
     * Submit the form to delete the screen type.
     *
     * @returns {void}
     */
    const submitForm = () => {
        router.delete(
            route("dashboard.screen_types.destroy", props.screen_type.id)
        );
    };
</script>
