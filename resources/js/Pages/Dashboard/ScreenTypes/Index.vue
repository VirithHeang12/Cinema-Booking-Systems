<template>
    <div class="screen-type-list-container">
        ...
        <data-table-server
            ...
            :emptyStateText="__('No screen type found in the database')"
            :emptyStateAction="true"
            :emptyStateActionText="__('Add First Screen Type')"
            @empty-action="createCallback"
            buttonVariant="outlined"
            :viewTooltip="__('View Screen Type Details')"
            :editTooltip="__('Edit Screen Type Information')"
            :deleteTooltip="__('Delete this Screen Type')"
