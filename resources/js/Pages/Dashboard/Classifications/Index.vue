<template>
    <data-table-server
        ...
        :createButtonText="__('New Classification')"
        ...
        :emptyStateText="__('No classifications found in the database')"
        :emptyStateAction="true"
        :emptyStateActionText="__('Add First Classification')"
        @empty-action="createCallback"
        buttonVariant="outlined"
        :viewTooltip="__('View Classification Details')"
        :editTooltip="__('Edit Classification Information')"
        :deleteTooltip="__('Delete this Classification')"
