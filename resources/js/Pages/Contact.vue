<template>
    <v-container>
      ...
      <div>
        ...
        <div class="row">
          <div class="col-12">
            <img
              ...
              alt="" class="img-fluid w-100 h-[200px] rounded-[25px]" />
          </div>
        </div>
        ...
        <h2 class="text-3xl font-semibold text-gray-600 mb-10">{{ __('contactPage.contact_info') }}</h2>
      
        <!-- Contact Form Section -->
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
  
          <!-- Hotline Card -->
          <div class="overflow-hidden rounded-lg border border-white/20 bg-secondary/50 bg-gray-800">
            <div class="border border-white/10 bg-white/10 px-4 py-3 lg:p-6">
              <h2 class="text-lg text-white font-extrabold">{{ __('contactPage.contact_info')  }}</h2>
            </div>
  
            <div class="space-y-4 p-4 lg:px-6 lg:py-9 mt-6">
              <div class="flex items-center gap-2.5 rounded-xl border border-white/5 bg-white/5 p-4 lg:gap-4 lg:p-5">
              ...
              <div>
                <a href="#" rel="noopener noreferrer" target="_blank" class="block"
                  ...
                  <div class="flex items-center gap-2.5 rounded-xl border-white/5 bg-white/5 p-4 lg:gap-4 lg:p-5">
          ...
          <div class="overflow-hidden rounded-lg border border-white/20 bg-secondary/50 bg-gray-800">
            <div class="border border-white/10 bg-white/10 px-4 py-3 lg:p-6">
              <h2 class="text-lg text-white font-extrabold">{{ __('contactPage.advertising_partnership_card') }}</h2>
            </div>
